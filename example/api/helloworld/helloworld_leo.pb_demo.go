...
//	SayHello(ctx context.Context, middlewares ...endpoint.Middleware) sd.Endpointer
//}
//
//type GreeterBalancers interface {
//	SayHello(ctx context.Context, middlewares ...endpoint.Middleware) lb.Balancer
//}
//
...
//	log              log.Logger
//	opts             []sd.EndpointerOption
//}
//
//func (e *greeterEndpointers) SayHello(ctx context.Context, middlewares ...endpoint.Middleware) sd.Endpointer {
//	instancer := e.instancerFactory.New(ctx, "")
//	hello := e.factories.SayHello(middlewares...)
//	return sd.NewEndpointer(instancer, hello, e.log, e.opts...)
//}
//
//func NewGreeterEndpointers(factories GreeterFactories, instancerFactory sdx.InstancerFactory, log log.Logger, opts []sd.EndpointerOption) GreeterEndpointers {
//	return &greeterEndpointers{instancerFactory: instancerFactory, factories: factories, log: log, opts: opts}
//}
//
...
//}
//
//func (b *greeterBalancers) SayHello(ctx context.Context, middlewares ...endpoint.Middleware) lb.Balancer {
//	return b.balancerFactory.New(ctx, b.GreeterEndpointers.SayHello(ctx, middlewares...))
//}
//
//func NewGreeterBalancers() GreeterBalancers {
