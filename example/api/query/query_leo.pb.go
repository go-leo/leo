...
type QueryHttpClientTransports interface {
	Query() *http.Client
}
...
func (t *queryHttpClientTransports) Query() *http.Client {
	return t.query
}
...
func NewQueryHttpClient(transports QueryHttpClientTransports, middlewares ...endpoint.Middleware) QueryService {
