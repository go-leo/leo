...
func AppendBoolQueryHttpServerRoutes(router *mux.Router, svc BoolQueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendInt32QueryHttpServerRoutes(router *mux.Router, svc Int32QueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendInt64QueryHttpServerRoutes(router *mux.Router, svc Int64QueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendUint32QueryHttpServerRoutes(router *mux.Router, svc Uint32QueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendUint64QueryHttpServerRoutes(router *mux.Router, svc Uint64QueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendFloatQueryHttpServerRoutes(router *mux.Router, svc FloatQueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendDoubleQueryHttpServerRoutes(router *mux.Router, svc DoubleQueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendStringQueryHttpServerRoutes(router *mux.Router, svc StringQueryService, middlewares ...endpoint.Middleware) *mux.Router {
...
func AppendEnumQueryHttpServerRoutes(router *mux.Router, svc EnumQueryService, middlewares ...endpoint.Middleware) *mux.Router {
