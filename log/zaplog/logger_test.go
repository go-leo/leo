...
func TestDebugZaplog(t *testing.T) {
	logger := zaplog.New(zaplog.LevelAdapt(log.LevelDebug))
...
func TestInfoZaplog(t *testing.T) {
...
func TestWarnZaplog(t *testing.T) {
...
func TestErrorZaplog(t *testing.T) {
