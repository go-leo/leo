...
func (x *StatusCode) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
type DetailInfo struct {
	...
	StatusCode *StatusCode `protobuf:"bytes,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`
	...
	ErrorInfo *errdetails.ErrorInfo `protobuf:"bytes,3,opt,name=error_info,json=errorInfo,proto3" json:"error_info,omitempty"`
	...
	QuotaFailure *errdetails.QuotaFailure `protobuf:"bytes,6,opt,name=quota_failure,json=quotaFailure,proto3" json:"quota_failure,omitempty"`
	// precondition_failure is the precondition failure.
	PreconditionFailure *errdetails.PreconditionFailure `protobuf:"bytes,7,opt,name=precondition_failure,json=preconditionFailure,proto3" json:"precondition_failure,omitempty"`
	// bad_request is the bad request.
	BadRequest *errdetails.BadRequest `protobuf:"bytes,8,opt,name=bad_request,json=badRequest,proto3" json:"bad_request,omitempty"`
	// request_info is the request info.
	RequestInfo *errdetails.RequestInfo `protobuf:"bytes,9,opt,name=request_info,json=requestInfo,proto3" json:"request_info,omitempty"`
	// resource_info is the resource info.
	ResourceInfo *errdetails.ResourceInfo `protobuf:"bytes,10,opt,name=resource_info,json=resourceInfo,proto3" json:"resource_info,omitempty"`
	// help is the help.
	Help *errdetails.Help `protobuf:"bytes,11,opt,name=help,proto3" json:"help,omitempty"`
	// localized_message is the localized message.
	LocalizedMessage *errdetails.LocalizedMessage `protobuf:"bytes,12,opt,name=localized_message,json=localizedMessage,proto3" json:"localized_message,omitempty"`
	// The HTTP response headers. The ordering of the headers is significant.
	// Multiple headers with the same key may present for the response.
...
func (x *DetailInfo) GetStatusCode() *StatusCode {
	if x != nil {
		return x.StatusCode
	}
	return nil
...
var file_error_proto_rawDesc = []byte{
	...
	0x22, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x22, 0x3a, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x30, 0x0a,
	0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16,
	...
	0xaf, 0x06, 0x0a, 0x0a, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x37,
	...
	0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6c, 0x65,
	0x6f, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x72, 0x52, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12,
	0x34, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x34, 0x0a, 0x0a, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x09, 0x72, 0x65, 0x74, 0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x34, 0x0a, 0x0a, 0x64,
	...
	,
...
var file_error_proto_goTypes = []interface{}{
	...
	(*StatusCode)(nil),                     // 2: leo.status.StatusCode
	(*Header)(nil),                         // 3: leo.status.Header
	(*DetailInfo)(nil),                     // 4: leo.status.DetailInfo
	(*status.Status)(nil),                  // 5: google.rpc.Status
	(*http.HttpHeader)(nil),                // 6: google.rpc.HttpHeader
	(*errdetails.ErrorInfo)(nil),           // 7: google.rpc.ErrorInfo
	(*errdetails.RetryInfo)(nil),           // 8: google.rpc.RetryInfo
	(*errdetails.DebugInfo)(nil),           // 9: google.rpc.DebugInfo
	(*errdetails.QuotaFailure)(nil),        // 10: google.rpc.QuotaFailure
	(*errdetails.PreconditionFailure)(nil), // 11: google.rpc.PreconditionFailure
	(*errdetails.BadRequest)(nil),          // 12: google.rpc.BadRequest
	(*errdetails.RequestInfo)(nil),         // 13: google.rpc.RequestInfo
	(*errdetails.ResourceInfo)(nil),        // 14: google.rpc.ResourceInfo
	(*errdetails.Help)(nil),                // 15: google.rpc.Help
	(*errdetails.LocalizedMessage)(nil),    // 16: google.rpc.LocalizedMessage
	(*anypb.Any)(nil),                      // 17: google.protobuf.Any
}
var file_error_proto_depIdxs = []int32{
	5,  // 0: leo.status.Error.grpc_status:type_name -> google.rpc.Status
	4,  // 1: leo.status.Error.detail_info:type_name -> leo.status.DetailInfo
	6,  // 2: leo.status.Header.headers:type_name -> google.rpc.HttpHeader
	2,  // 3: leo.status.DetailInfo.status_code:type_name -> leo.status.StatusCode
	1,  // 4: leo.status.DetailInfo.identifier:type_name -> leo.status.Identifier
	7,  // 5: leo.status.DetailInfo.error_info:type_name -> google.rpc.ErrorInfo
	8,  // 6: leo.status.DetailInfo.retry_info:type_name -> google.rpc.RetryInfo
	9,  // 7: leo.status.DetailInfo.debug_info:type_name -> google.rpc.DebugInfo
	10, // 8: leo.status.DetailInfo.quota_failure:type_name -> google.rpc.QuotaFailure
	11, // 9: leo.status.DetailInfo.precondition_failure:type_name -> google.rpc.PreconditionFailure
	12, // 10: leo.status.DetailInfo.bad_request:type_name -> google.rpc.BadRequest
	13, // 11: leo.status.DetailInfo.request_info:type_name -> google.rpc.RequestInfo
	14, // 12: leo.status.DetailInfo.resource_info:type_name -> google.rpc.ResourceInfo
	15, // 13: leo.status.DetailInfo.help:type_name -> google.rpc.Help
	16, // 14: leo.status.DetailInfo.localized_message:type_name -> google.rpc.LocalizedMessage
	3,  // 15: leo.status.DetailInfo.header:type_name -> leo.status.Header
	17, // 16: leo.status.DetailInfo.extra:type_name -> google.protobuf.Any
