# 断路器
断路器是一种保护机制，它可以防止系统过载。它可以在一段时间内停止向系统发送请求，以防止系统过载。

Leo内置了场景三种断路器：
- [sony go breaker 断路器](https://github.com/sony/gobreaker)
- [google sre 断路器](https://sre.google/sre-book/handling-overload/)
- [hystrix 断路器](https://github.com/afex/hystrix-go)
...
# 代码
[circuitbreaker](../example/circuitbreaker)