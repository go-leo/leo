...
// UnaryServerInterceptor creates the unary server interceptor wrapped with Sentinel entry.
...
// StreamServerInterceptor creates the unary stream interceptor wrapped with Sentinel entry.
